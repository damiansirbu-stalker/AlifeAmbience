...
META_SCRIPT = os.path.join(GD, "scripts", "aa_sound_meta_gen.script")
...
def _write_meta_script(rows):
    ...
    lines = [
        "--- aa_sound_meta_gen: GENERATED by tools/merge.py, do not edit. Deployed path -> measured profile.",
...
def cmd_meta():
    """Emit aa_sound_meta_gen.script: each deployed sound's measured profile for the in-game readout.
    ...
    print(f"meta: {len(rows)} profiles -> aa_sound_meta_gen.script ({measured} newly measured)")
